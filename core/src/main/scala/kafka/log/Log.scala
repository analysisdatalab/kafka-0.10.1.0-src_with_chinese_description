...
class Log(val dir: File,
  ...
  //目的就是为了根据offset快速定位到对应的LogSegment
  ...
  def deleteOldSegments(): Int = {
    ...
    //todo: 按照时间和文件大小维度进行删除     默认是没有启动按照文件大小删除
